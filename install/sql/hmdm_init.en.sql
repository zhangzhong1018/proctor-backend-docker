...
ALTER TABLE "public"."userrolesettings" ADD COLUMN columndisplayeddeviceorganization bool;
...
ALTER TABLE "public"."users" ADD COLUMN locationid int4;

CREATE SEQUENCE network_id_seq START 1;
...
CREATE SEQUENCE deviceslogs_id_seq START 1;
CREATE TABLE "public"."deviceslogs" (
                                        ...
                                        "createtime" int8,
                                        "duration" int8,
                                        CONSTRAINT "deviceslogs_pkey" PRIMARY KEY ("id")
);

ALTER TABLE "public"."devices" ADD COLUMN frmwareversion varchar(255);
ALTER TABLE "public"."devices" ADD COLUMN uKey bool;
ALTER TABLE "public"."devices" ADD COLUMN systemversion varchar(255);
ALTER TABLE "public"."devices" ADD COLUMN mainboardtype varchar(255);
ALTER TABLE "public"."devices" ADD COLUMN screenLockState bool;



CREATE SEQUENCE applicationcatalogues_id_seq START 1;
CREATE TABLE "public"."applicationcatalogues" (
                                                  ...
                                                  "name" varchar(500),
                                                  "icontext" varchar(256),
                                                  "iconid" int4,
                                                  "type" int4,
                                                  CONSTRAINT "applicationcatalogues_pkey" PRIMARY KEY ("id")
);

ALTER TABLE "public"."applications" ADD COLUMN categoryid int4;
...
ALTER TABLE "public"."users" ADD COLUMN orgcode varchar(32);
ALTER TABLE "public"."devices" ADD COLUMN orgcode varchar(32);
ALTER TABLE "public"."groups" ADD COLUMN orgcode varchar(32);
ALTER TABLE "public"."configurations" ADD COLUMN orgcode varchar(32);
ALTER TABLE "public"."broadcasts" ADD COLUMN orgcode varchar(32);
ALTER TABLE "public"."organizations" ADD COLUMN locationid int4;
...
INSERT INTO "public"."organizations" VALUES (1, '00', 'Collab Group', 'CGP', 'Collab Group', NULL, 1, NULL);
